    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent != null){
            ...
            if (addresses == null || addresses.isEmpty()) {
                ...
                Toast.makeText(this, "Couldn't fetch location" + errorMessage, Toast.LENGTH_SHORT).show();
            } else {
                ...
                deliverResultToReceiver(Constants.SUCCESS_RESULT,
                        TextUtils.join(Objects.requireNonNull(System.getProperty("line.seperator")),
                                addressFragments)
                );
            }
